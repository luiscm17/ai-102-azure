...
from azure.ai.agents.models import FunctionTool, ConnectedAgentTool, MessageRole, ListSortOrder, ToolSet
...
with agents_client:
    ...
    priority_agent_isntructions = """
    Assess how urgent a ticket is based on it description.
    ...
    Only output the urgency level and very brief explanation.
    """

    priority_agent = agents_client.create_agent(
        model=model_deployment,
        name=priority_agent_name,
        instructions=priority_agent_isntructions
    )
    ...
    -Small: Can be completed ins a day
    ...
    effort_agent_tool = ConnectedAgentTool(
        id=effort_agent.id,
        name=effort_agent_name,
        description="Determines the effort required to complete a ticket"
    )
