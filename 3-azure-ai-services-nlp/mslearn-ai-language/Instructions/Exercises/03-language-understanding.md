...
1. When prompted, enter utterances to test the application. For example, try:
    ...
    *What day is 01/01/2025?*
    ...
    > [!NOTE] 
    >The logic in the application is deliberately simple, and has a number of limitations. For example, when getting the time, only a restricted set of cities is supported and daylight savings time is ignored. The goal is to see an example of a typical pattern for using Language Service in which your application must:
