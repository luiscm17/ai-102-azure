...
1. At the bottom of the navigation pane on the left, select **Management center**. The management center is where you can configure settings at both the _resource_ and _project_ levels; which are both shown in the navigation pane.
...
The Azure AI Foundry project includes a number of _endpoints_ that client applications can use to connect to the project and the models and AI services it includes.
